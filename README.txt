...
a persistence unit "evarestPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "evarest/pom.xml":
...
artifact ("evarest.war") is already built. You can build
